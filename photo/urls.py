...
urlpatterns = [
    ...
    path('mypage/<str:user_id>', photo_list_user, name='photo_list_user'),
    path('follow/<str:user_id>', FollowingView.as_view(), name='following'),
    path('unfollow/<int:pk>', UnFollowingView.as_view(), name='unfollowing'),
    path('search/<str:user_name>', search_user, name='search_user'),
